...
public class LegacyNuclearRemainsBlock extends SimpleRadioactiveBlock {
    private static final int decayChanceTo0 = 2;
    private final BlockState decay;
    public LegacyNuclearRemainsBlock(Properties properties, float rads, BlockState decay) {
