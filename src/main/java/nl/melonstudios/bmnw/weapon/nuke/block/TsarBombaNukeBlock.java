...
public class TsarBombaNukeBlock extends NukeBlock implements EntityBlock, IScrewdriverUsable {
    ...
    public boolean isReady(Level level, BlockPos pos) {
        if (level.getBlockEntity(pos) instanceof TsarBombaBE be) {
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new TsarBombaBE(pos, state);
    }
