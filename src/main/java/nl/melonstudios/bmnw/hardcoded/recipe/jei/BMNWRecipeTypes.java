...
public class BMNWRecipeTypes {
    ...
    public static final RecipeType<RecipeHolder<BuildersSmeltingRecipe>> BUILDERS_SMELTING =
            RecipeType.createFromDeferredVanilla(BMNWRecipes.BUILDERS_SMELTING_TYPE).get();
}
