...
public class CaseohRenderer extends EntityRenderer<CaseohEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(CaseohEntity entity) {
        return DRAGON_LOCATION;
    }

    @Override
    public boolean shouldRender(CaseohEntity livingEntity, Frustum camera, double camX, double camY, double camZ) {
        return true;
    }
}
