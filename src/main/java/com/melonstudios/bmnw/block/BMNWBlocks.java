package com.melonstudios.bmnw.block;

import com.melonstudios.bmnw.block.custom.*;
import com.melonstudios.bmnw.block.settype.BMNWBlockSetType;
import com.melonstudios.bmnw.category.MissileCategory;
import com.melonstudios.bmnw.entity.custom.AntiMissileMissileEntity;
...
import com.melonstudios.bmnw.misc.Categories;
...
public class BMNWBlocks {
    ...
    public static final DeferredBlock<BarbedWireBlock> BARBED_WIRE = BLOCKS.register("barbed_wire",
            () -> new BarbedWireBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK),
